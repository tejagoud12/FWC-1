...
\item If two chords $AB$ and $CD$ of a circle AYDZBWCX intersect at right angles see Fig \ref{Fig-1}. Prove that
	...
	\end{align*}
\begin{figure}[h!]                                   \includegraphics[width=\columnwidth]{image1.jpg}                            \caption{}                                       \label{Fig-1}                    \end{figure}
...
\angle AEC=\frac{1}{2} (\text{Angle subtended by arc CXA at centre}\\ + \text{angle subtended by arc DYB at the centre}).
		\end{align*}
	\begin{figure}[h!]                                   \includegraphics[width=\columnwidth]{image2.jpg}                           \caption{}                                       \label{Fig-2}                    \end{figure}
...
\item In Fig \ref{Fig-3}, $\vec{O}$ is the centre of the circle, $\angle BCO=30\degree$.Find $x$ and $y$
	\begin{figure}[h!]                                   \includegraphics[width=\columnwidth]{image3.jpg}                            \caption{}                                       \label{Fig-3}                    \end{figure}
	\item In fig \ref{Fig-4}, $\vec{O}$ is the centre of the circle,$BD=0D$ and $CD \bot AB$. Find $\angle CAB$
	\begin{figure}[h!]                      \includegraphics[width=\columnwidth]{image4.jpg}                              \caption{}                                       \label{Fig-4}                    \end{figure}
\end{enumerate}
