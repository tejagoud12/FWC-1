...
\item If two chords $AB$ and $CD$ of a circle AYDZBWCX intersect at right angles see Fig.\ref{fig:1}. Prove that
	...
	\end{align}
\begin{figure}[h!]                                   \includegraphics[width=\columnwidth]{figs/image1.jpg}                            \caption{}                                       \label{fig:1}                    \end{figure}
...
\angle AEC=\frac{1}{2} (\text{Angle subtended by arc CXA at centre}\\ + \text{angle subtended by arc DYB at the centre}).
		\end{align}
	\begin{figure}[h!]                                   \includegraphics[width=\columnwidth]{figs/image2.jpg}                           \caption{}                                       \label{fig:2}                    \end{figure}
...
\item In Fig.\ref{fig:3}, $\vec{O}$ is the centre of the circle, $\angle BCO=30\degree$. Find $x$ and $y$.
	\begin{figure}[h!]                                   \includegraphics[width=\columnwidth]{figs/image3.jpg}                            \caption{}                                       \label{fig:3}                    \end{figure}
	\item In Fig.\ref{fig:4}, $\vec{O}$ is the centre of the circle, $BD=OD$ and $CD \bot AB$. Find $\angle CAB$.
		\begin{figure}[h!]                      \includegraphics[width=\columnwidth]{figs/image4.jpg}                              \caption{}                                       \label{fig:4}                    \end{figure}
\end{enumerate}
