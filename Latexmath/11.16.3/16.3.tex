...
\item If $e_1 ,e_2, e_3, e_4$ are the four elementary out comes in a sample space and P (e,)=.1 'P ($e_3$)=.1, then the probability of e4 is \rule{1cm}{0.15mm}
\item Let s ={1.2,3,4,5,6} and E={11,3,5}, then E is \rule{1cm}{0.15mm}
\item If A and B are two events associated  with a rondom experiment such that P (A)=0.3, P(B)=0.2 and P (A$\cap$B)=0.1 then the value of P (A$\cap$B) is \rule{1cm}{0.15mm}
\item The probability of happening of an event A is 0.5 and that of B is 0.3 lf A and B are mutually exclusive events, then the probability of neither A nor B is \rule{1cm}{0.15mm}
\\\\\\
